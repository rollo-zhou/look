var Fireworks = function(){
    ...
    self.dt = 0;
		...
		self.canvas.width = self.cw = $("body").css("width").replace("px","")-0;
		self.canvas.height = self.ch = $("body").css("height").replace("px","")-0;
  ...
  self.updateDelta = function(){
    ...
    self.updateDelta();
		...
		self.ctx.fillStyle = 'rgba(250,250,250,'+self.clearAlpha/100+')';
